...
<html>
    ...
    <body style="font-size: 12px">
        ...
        <div class="row">
            ...
            <div class="col s4 m4 l4 z-depth-1 grey lighten-1 margin_top_7px">

                <div id="div_gestor_gestion" class=" col s12 m12 l12 div_gestor_gestion">
            ...
            <div class="col s4 m4 l4 grey lighten-1 div_data_aval marcacion_directa z-depth-1">
                <div class="col s12 input-field">
                    ...
                    <div id="div_input_gestor_tiempos" class="col s12 m12 l12 div_input_gestor_tiempos">
        ...
        <script type="text/javascript" src="js/js/predictivo_azteca_version_3.js"></script>
    </body>
</html>